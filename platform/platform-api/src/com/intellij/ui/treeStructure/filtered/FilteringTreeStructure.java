...
//  private final ElementFilter<Object> myFilter;
  ...
  public FilteringTreeStructure(//@NotNull ElementFilter filter,
                                @NotNull AbstractTreeStructure originalStructure) {
    this(originalStructure, true);
  }

  public FilteringTreeStructure(//@NotNull ElementFilter filter,
                                @NotNull AbstractTreeStructure originalStructure, boolean initNow) {
