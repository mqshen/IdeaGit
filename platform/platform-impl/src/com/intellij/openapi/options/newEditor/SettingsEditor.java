...
//  private final SettingsFilter myFilter;
  private SettingsTreeView myTreeView;
  ...
  private void installSpotlightRemover() {
    final FocusAdapter spotlightRemover = new FocusAdapter() {
      ...
      public void focusLost(FocusEvent e) {
        ...
        if ( comp == myTreeView.myTree) {
          return;
        }
        mySpotlightPainter.update(null, null);
      }
...
//    }
  ...
  Collection<@NlsContexts.ConfigurableName String> getPathNames() {
    return null;//myTreeView == null ? null : myTreeView.getPathNames(myFilter.myContext.getCurrentConfigurable());
  }
