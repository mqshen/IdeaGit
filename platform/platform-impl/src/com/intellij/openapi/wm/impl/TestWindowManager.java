...
public final class TestWindowManager extends WindowManagerEx {
  ...
  private static final class DummyStatusBar implements StatusBarEx {
    ...
    private List<StatusBarWidget> allWidgets = new ArrayList<>();

    public Map<String, StatusBarWidget> getMyWidgetMap() {
      return myWidgetMap;
    }


    public void addListener(StatusBarListener listener , Disposable parentDisposable ) {}

    @Nullable
    @Override
    public List<StatusBarWidget> getAllWidgets() {
      return allWidgets;
    }

    public void setAllWidgets(List<StatusBarWidget> allWidgets) {
    ...
    public String getWidgetAnchor(String id){
      return null;
    }
