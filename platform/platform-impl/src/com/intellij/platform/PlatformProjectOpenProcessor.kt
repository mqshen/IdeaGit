...
//        this.callback = callback
        runConfigurators = false//callback != null
        this.line = line
      }
    ...
    @JvmStatic
    @RequiresEdt
    fun attachToProject(project: Project, projectDir: Path): Boolean {
      return runWithModalProgressBlocking(project, "") {
        attachToProjectAsync(projectToClose = project, projectDir = projectDir)
      }
    }
...
@Internal
suspend fun attachToProjectAsync(projectToClose: Project, projectDir: Path): Boolean {
